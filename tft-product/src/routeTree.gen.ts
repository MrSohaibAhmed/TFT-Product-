...
import { Route as AuthenticatedUserDetailsUserIdImport } from './routes/_authenticated/userDetails/$userId'
...
const AuthenticatedUserDetailsUserIdRoute =
  AuthenticatedUserDetailsUserIdImport.update({
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_authenticated/userDetails/$userId': {
      id: '/_authenticated/userDetails/$userId'
      path: '/userDetails/$userId'
      fullPath: '/userDetails/$userId'
      preLoaderRoute: typeof AuthenticatedUserDetailsUserIdImport
      parentRoute: typeof AuthenticatedRouteImport
    }
    '/_authenticated/settings/account': {
...
interface AuthenticatedRouteRouteChildren {
  ...
  AuthenticatedUserDetailsUserIdRoute: typeof AuthenticatedUserDetailsUserIdRoute
...
const AuthenticatedRouteRouteChildren: AuthenticatedRouteRouteChildren = {
  ...
  AuthenticatedUserDetailsUserIdRoute: AuthenticatedUserDetailsUserIdRoute,
...
export interface FileRoutesByFullPath {
  ...
  '/userDetails/$userId': typeof AuthenticatedUserDetailsUserIdRoute
...
export interface FileRoutesById {
  ...
  '/_authenticated/userDetails/$userId': typeof AuthenticatedUserDetailsUserIdRoute
...
/* ROUTE_MANIFEST_START
{
  "routes": {
    ...
    "/_authenticated/userDetails/$userId": {
      "filePath": "_authenticated/userDetails/$userId.tsx",
      "parent": "/_authenticated"
    },
    "/_authenticated/settings/account": {
